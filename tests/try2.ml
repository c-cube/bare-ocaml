...
let () =
  ...
  let p1 = E.Person.Employee
      {E.Employee. name="bar"; email="bar@iHaveAVeryLongEmailRight.edu.ac.co.uk";
       ...
       metadata=Bare.String_map.singleton "level" (Bytes.of_string "triple A grade!");
       address={E.Address.address=[|"12"; "business avenue"; "front"; "center"|];
                city="Business City"; state="HQ"; country="Office Space 1";
               }
      } in
